...
[新規 import]
   ...
   draft or approved / human-owned   … 以後importはcanonicalの人間所有列を上書きしない
...
| 値 | 意味 |
|---|---|
| draft | 下書き。新規importはここから開始 |
| approved | 承認済み。is_stale化しない（承認意思の保護） |
| archived | アーカイブ。ソフトデリート。ミラー停止の絶対境界 |
